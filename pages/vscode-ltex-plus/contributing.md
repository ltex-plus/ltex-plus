...
2. Make sure that your issue can neither be found in the list of known issues below nor in the [list of all open and closed GitHub issues](https://github.com/valentjn/vscode-ltex-plus/issues?q=is%3Aissue).
...
7. Do one of the following:
   ...
   - Manually [open an issue on GitHub](https://github.com/valentjn/vscode-ltex-plus/issues/new/choose), select the `Bug Report` template, and fill in as much info as you can (the [`LTeX: Report Bug in LTeX`](commands.html#ltex-report-bug-in-ltex) command would do that for you). This will help us reproduce the issue.
...
2. Make sure that your feature is not in the [list of all open and closed GitHub issues](https://github.com/valentjn/vscode-ltex-plus/issues?q=is%3Aissue).
3. Do one of the following:
   ...
   - Manually [open an issue on GitHub](https://github.com/valentjn/vscode-ltex-plus/issues/new/choose) and select the `Feature Request` template.
...
1. Check whether a pre-release is available on the [releases pages of vscode-ltex](https://github.com/valentjn/vscode-ltex-plus/releases) (pre-releases, if there are any, are at the top of the page).
...
5. Check if all currently listed changes in the [changelog on the `develop` branch](https://github.com/valentjn/vscode-ltex-plus/blob/develop/changelog.xml) work as announced.
...
| [vscode-ltex / coc-ltex → Commands](https://ltex-plus.github.io/ltex-plus/vscode-ltex-plus/commands.html) | [`package.json`](https://github.com/valentjn/vscode-ltex-plus/blob/develop/package.json), [`package.nls.json`](https://github.com/valentjn/vscode-ltex-plus/blob/develop/package.nls.json) |
| [vscode-ltex / coc-ltex → Changelog](https://ltex-plus.github.io/ltex-plus/vscode-ltex-plus/changelog.html) | [`vscode-ltex/changelog.xml`](https://github.com/valentjn/vscode-ltex-plus/blob/develop/changelog.xml) |
| [vscode-ltex / coc-ltex → Contributing](https://ltex-plus.github.io/ltex-plus/vscode-ltex-plus/contributing.html) | [`vscode-ltex/CONTRIBUTING.md`](https://github.com/valentjn/vscode-ltex-plus/blob/develop/CONTRIBUTING.md) |
...
1. Duplicate [`package.nls.de.json`](https://github.com/valentjn/vscode-ltex-plus/blob/develop/package.nls.de.json), replacing `de` with the [ISO 639-1 language code](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) of your language.
