...
- You want to use [LanguageTool Plus](https://languagetoolplus.com/), the paid version of LT, to get access to Premium rules. In this case, set [`ltex.languageToolHttpServerUri`](settings.html#ltexlanguagetoolhttpserveruri) to `https://api.languagetoolplus.com/` and provide your credentials via [`ltex.languageToolOrg.username`](settings.html#ltexlanguagetoolorgusername) and [`ltex.languageToolOrg.apiKey`](settings.html#ltexlanguagetoolorgapikey).
