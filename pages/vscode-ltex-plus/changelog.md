...
- &#x1f527; *Change:* Update LanguageTool from 6.0 to 6.5 again (see [LT 6.5 release notes](https://github.com/languagetool-org/languagetool/blob/v6.5/languagetool-standalone/CHANGES.md)). LTeX+ LS 18.1.0 including Java 21 is now used.
...
- &#x1f527; *Change:* Update LanguageTool from 6.0 to 6.5 (see [LT 6.5 release notes](https://github.com/languagetool-org/languagetool/blob/v6.5/languagetool-standalone/CHANGES.md)). LTeX+ LS 18.1.0 including Java 21 is now used.
...
- &#x1f527; *Change:* Update LanguageTool from 5.5 to 6.0 (see [LT 6.0 release notes](https://github.com/languagetool-org/languagetool/blob/v6.0/languagetool-standalone/CHANGES.md)). LTeX+ LS 17.0.1 is now used.
- &#x1f527; *Change:* Update to LSP 3.17.5 and vscode-languageclient 9.0.1

## 13.1.2 &#x2014; &#x201c;The Stray Java Process Reaction&#x201d; (August 18, 2024)

- &#x1f41b; *Bug fix:* Fix stray Java process. &#x2014; [valentjn/vscode-ltex#497](https://github.com/valentjn/vscode-ltex/issues/497)
...
- &#x2728; *New:* Always check selected text when running [`LTeX: Check Selection`](commands.html#ltex-check-selection), even non-comment parts of programs &#x2014; [valentjn/vscode-ltex#457](https://github.com/valentjn/vscode-ltex/issues/457)
...
- &#x1f41b; *Bug fix:* Fix `StringIndexOutOfBoundsException` in `AnnotatedTextFragment.getSubstringOfPlainText` &#x2014; [vscode-ltex#442](https://github.com/ltex-plus/vscode-ltex/issues/442)
...
- &#x2728; *New:* Add completion support for English and German (begin typing a word and press `Ctrl+Space`) &#x2014; [valentjn/vscode-ltex#409](https://github.com/valentjn/vscode-ltex/issues/409)
...
- &#x2728; *New:* Add support for coc.nvim (Vim/Neovim) &#x2014; [valentjn/ltex-ls#103](https://github.com/valentjn/ltex-ls/issues/103)
...
- &#x1f41b; *Bug fix:* Validate keys of [`ltex.dictionary`](../settings.html#ltexdictionary), [`ltex.disabledRules`](../settings.html#ltexdisabledrules), [`ltex.enabledRules`](../settings.html#ltexenabledrules), and [`ltex.hiddenFalsePositives`](../settings.html#ltexhiddenfalsepositives) &#x2014; [valentjn/vscode-ltex#381](https://github.com/valentjn/vscode-ltex/issues/381)
...
- &#x1f41b; *Bug fix:* Fix markup before actual grammar/spelling errors included in errors &#x2014; [valentjn/vscode-ltex#349](https://github.com/valentjn/vscode-ltex/issues/349)
...
- &#x1f41b; *Bug fix:* Fix LTeX LS not closed when VS Code or workspace is closed &#x2014; [valentjn/vscode-ltex#325](https://github.com/valentjn/vscode-ltex/issues/325)
...
- &#x1f41b; *Bug fix:* Fix almost infinite loops when checking very long documents &#x2014; [valentjn/vscode-ltex#253](https://github.com/valentjn/vscode-ltex/issues/253)
...
- &#x2728; *New:* Add support for Org &#x2014; [valentjn/vscode-ltex#277](https://github.com/valentjn/vscode-ltex/issues/277)
- &#x2728; *New:* Add basic support for reStructuredText &#x2014; [valentjn/vscode-ltex#32](https://github.com/valentjn/vscode-ltex/issues/32)
...
- &#x1f41b; *Bug fix:* Hide internal commands in table of keyboard shortcuts to prevent confusion &#x2014; [valentjn/vscode-ltex#282](https://github.com/valentjn/vscode-ltex/issues/282)
...
- &#x2728; *New:* Add support for many accents in LaTeX: double acute (e.g., `\H{O}`, &#x0150;), line below (e.g., `\b{h}`, &#x1e96;), dot below (e.g., `\d{A}`, &#x1ea0;), ogonek (e.g., `\k{A}`, &#x0104;), breve (e.g., `\u{A}`, &#x0102;), and caron (e.g., `\v{C}`, &#x010c;) &#x2014; [valentjn/ltex-ls#56](https://github.com/valentjn/ltex-ls/issues/56), [ltex-ls#57](https://github.com/ltex-plus/ltex-ls/issues/57), [@ed359](https://github.com/ed359)
- &#x2728; *New:* Add support for special characters in LaTeX: `\L` (&#x0141;), `\SS` (&#x1e9e;), `\i` (&#x0131;), `\j` (&#x0237;), and `\l` (&#x0142;) &#x2014; [valentjn/ltex-ls#56](https://github.com/valentjn/ltex-ls/issues/56), [ltex-ls#57](https://github.com/ltex-plus/ltex-ls/issues/57), [@ed359](https://github.com/ed359)
...
- &#x1f527; *Change:* Use LaTeX parser for documents with code language ID `tex` &#x2014; [valentjn/ltex-ls#53](https://github.com/valentjn/ltex-ls/issues/53), [ltex-ls#54](https://github.com/ltex-plus/ltex-ls/issues/54), [Lucas Alber (@LDAP)](https://github.com/LDAP)
- &#x1f527; *Change:* Change type of [`ltex.additionalRules.motherTongue`](../settings.html#ltexadditionalrulesmothertongue) to `enum` to clarify possible values &#x2014; [valentjn/vscode-ltex#260](https://github.com/valentjn/vscode-ltex/issues/260)
...
- &#x1f41b; *Bug fix:* Fix LTeX LS not starting if Java version string does not contain a minor version (e.g., `"16"`) &#x2014; [valentjn/vscode-ltex#224](https://github.com/valentjn/vscode-ltex/issues/224)
...
- &#x1f41b; *Bug fix:* Fix documentation on the number of backslashes for [`ltex.latex.commands`](../settings.html#ltexlatexcommands) &#x2014; [valentjn/vscode-ltex#232](https://github.com/valentjn/vscode-ltex/issues/232)
...
- &#x1f527; *Change:* Only check file types for which LTeX has been enabled when running [`LTeX: Check All Documents in Workspace`](commands.html#ltex-check-all-documents-in-workspace) &#x2014; [valentjn/vscode-ltex#183](https://github.com/valentjn/vscode-ltex/issues/183)
...
- &#x1f527; *Change:* Avoid misleading popup prompting to install Java on Mac, use `ltex.java.forceTrySystemWide` to force trying a system-wide Java installation &#x2014; [valentjn/vscode-ltex#162](https://github.com/valentjn/vscode-ltex/issues/162)
...
- &#x2728; *New:* Add commands [`LTeX: Check Current Document`](commands.html#ltex-check-current-document) and [`LTeX: Check All Documents in Workspace`](commands.html#ltex-check-all-documents-in-workspace) &#x2014; [valentjn/vscode-ltex#84](https://github.com/valentjn/vscode-ltex/issues/84)
...
- &#x1f41b; *Bug fix:* Fix another problem with spaces in paths when using LTeX LS on Windows &#x2014; [valentjn/vscode-ltex#80](https://github.com/valentjn/vscode-ltex/issues/80)
- &#x1f527; *Change:* Update LTeX LS to 6.1.1

## 6.1.0 &#x2014; &#x201c;The babel Momentum&#x201d; (July 26, 2020)

- &#x2728; *New:* Download Java 11 if only Java 8 is installed; LTeX support for Java 8 will end on November 1, 2020 (see [documentation](https://ltex-plus.github.io/ltex-plus/old/deprecation-of-java-8.html)) &#x2014; [valentjn/vscode-ltex#39](https://github.com/valentjn/vscode-ltex/issues/39)
...
- &#x1f41b; *Bug fix:* Fix problems with spaces in paths when using LTeX LS on Windows &#x2014; [valentjn/vscode-ltex#80](https://github.com/valentjn/vscode-ltex/issues/80)
...
- &#x1f527; *Change:* Make Windows startup script of LTeX LS (`ltex-ls.bat`) honor `JAVA_HOME` &#x2014; [valentjn/vscode-ltex#75](https://github.com/valentjn/vscode-ltex/issues/75)
...
- &#x1f41b; *Bug fix:* Fix `Disable rule` quick fix using wrong setting structure &#x2014; [valentjn/vscode-ltex#61](https://github.com/valentjn/vscode-ltex/issues/61)

## 5.0.1 &#x2014; &#x201c;The Acceptance Incursion&#x201d; (June 7, 2020)

- &#x1f41b; *Bug fix:* Fix `Value is not accepted` warning when using [`ltex.disabledRules`](../settings.html#ltexdisabledrules) or [`ltex.enabledRules`](../settings.html#ltexenabledrules) &#x2014; [valentjn/vscode-ltex#44](https://github.com/valentjn/vscode-ltex/issues/44)
- &#x1f527; *Change:* Change badges in readme

## 5.0.0 &#x2014; &#x201c;The Rewrite Materialization&#x201d; (June 1, 2020)

- &#x2728; *New:* Download LTeX LS on demand with all languages already included; this removes the need for language support extensions &#x2014; [valentjn/vscode-ltex#6](https://github.com/valentjn/vscode-ltex/issues/6)
- &#x1f527; *Change:* Download Java distribution on demand if no suitable Java installation has been found &#x2014; [valentjn/vscode-ltex#5](https://github.com/valentjn/vscode-ltex/issues/5)
...
- &#x1f527; *Change:* Make documentation more extensive, put it on own [website](https://ltex-plus.github.io/ltex-plus)
...
- &#x2728; *New:* Add `ltex.javaHome` setting to control the `JAVA_HOME` environment variable &#x2014; [valentjn/vscode-ltex#24](https://github.com/valentjn/vscode-ltex/issues/24), [@mpolitze](https://github.com/mpolitze)
...
- &#x1f41b; *Bug fix:* Fix language extensions not installable on remote machines &#x2014; [valentjn/vscode-ltex#8](https://github.com/valentjn/vscode-ltex/issues/8)
...
- &#x1f527; *Change:* Don't check plaintext files &#x2014; [valentjn/vscode-ltex#4](https://github.com/valentjn/vscode-ltex/issues/4)
